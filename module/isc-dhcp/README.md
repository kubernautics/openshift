...
sudo podman run \
    ...
    --cap-add=NET_ADMIN                                                        \
    --publish 67:67/udp                                                        \
    --volume ~/ccio/ccio-isc-dhcp/config/dhcpd.conf:/etc/dhcp/dhcpd.conf       \
    --volume ~/ccio/ccio-isc-dhcp/config/dhcp:/etc/dhcp/                       \
    --volume ~/ccio/ccio-isc-dhcp/config/defaults:/etc/defaults                \
